...
<div class="row">
	<div class="col-sm-12">
		<div class="breadcrumb">
			...
			<center><h4>
				<i class="fa fa-file-text-o"></i> Registro de Analisis - Granja Tarapoto
			</h4></center>
		</div>
	</div>
</div> <br><br>
			...
			<div class="row">
					<div class="col-sm-12">
						...
						<table class="table table-bordered table-hover table-full-width" id="sample_1">
							...
							<tbody id="data_body">
								<?php
									if(count($registro_analisis)>0) {
										foreach ($registro_analisis as $value) {
						...
						<div class="panel panel-default">
							<div class="panel-body">
								<form class="form-horizontal" id="form"> <br>
									<input type="hidden" name="rga_fecha" id="rga_fecha" value="<?php echo date("Y-m-d"); ?>">
									<input type="hidden" name="id" id="id">
									<div class="form-group">
										<label class="col-sm-3 control-label">Animal</label>
										<div class="col-sm-9">
											<?php echo form_dropdown('rga_animal', $animal,"", 'class="form-control" required'); ?>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">Tipo Analisis</label>
										<div class="col-sm-9">
