...
<div class="row">
	<div class="col-sm-12">
		<div class="breadcrumb">
			...
			<center><h4>
				<i class="fa fa-file-text-o"></i> Resultado de Analisis - Granja Tarapoto
			</h4></center>
		</div>
	</div>
</div> <br><br>
			...
			<div class="row">
					<div class="col-sm-12">
						...
						<table class="table table-bordered table-hover table-full-width" id="sample_1">
							...
							<tbody id="data_body">
								<?php
									if(count($resultado_analisis)>0) {
										foreach ($resultado_analisis as $value) {
			...
			<div class="sidebar-wrapper">
				<ul class="nav nav-tabs nav-justified" id="sidebar-tab">
					<li class="active" style="font-size:18px;padding:5px;">
						<a href="#users" role="tab" data-toggle="tab"><i class="fa fa-list"></i> Registro Resultado Analisis</a>
					</li>
				</ul>
							...
							<div class="panel-body">
								<form class="form-horizontal" id="form"> <br>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<?php echo form_input('res_descripcion',"",'id="res_descripcion" class="form-control" required'); ?>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">Abreviatura</label>
										<div class="col-sm-9">
											<?php echo form_input('res_abreviatura',"", 'id="res_abreviatura" class="form-control" required'); ?>
										</div>
									</div>
									<br>
