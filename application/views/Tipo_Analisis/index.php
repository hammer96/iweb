...
<div class="row">
	<div class="col-sm-12">
		<div class="breadcrumb">
			...
			<center><h4>
				<i class="fa fa-file-text-o"></i> Tipo de Analisis - Granja Tarapoto
			</h4></center>
		</div>
	</div>
</div> <br><br>
			...
			<div class="row">
					<div class="col-sm-12">
						...
						<table class="table table-bordered table-hover table-full-width" id="sample_1">
							...
							<tbody id="data_body">
								<?php
									if(count($tipo_analisis)>0) {
										foreach ($tipo_analisis as $value) {
			...
			<div class="sidebar-wrapper">
				<ul class="nav nav-tabs nav-justified" id="sidebar-tab">
					<li class="active" style="font-size:18px;padding:5px;">
						<a href="#users" role="tab" data-toggle="tab"><i class="fa fa-list"></i> Registro Tipo Analisis</a>
					</li>
				</ul>
