...
<div class="row">
	<div class="col-sm-12">
		<div class="breadcrumb">
			...
			<center><h4>
				<i class="fa fa-file-text-o"></i> Tipo de Registro - Granja Tarapoto
			</h4></center>
		</div>
	</div>
</div> <br><br>
			...
			<div class="row">
					<div class="col-sm-12">
						...
						<table class="table table-bordered table-hover table-full-width" id="sample_1">
							...
							<tbody id="data_body">
								<?php
									if(count($tipo_registro)>0) {
										foreach ($tipo_registro as $value) {
							...
							<div class="panel-body">
								<form class="form-horizontal" id="form"> <br>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<?php echo form_input('tiporeg_descripcion',"",'id="tiporeg_descripcion" class="form-control" required'); ?>
										</div>
									</div>
