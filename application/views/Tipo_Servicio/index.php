...
<div class="row">
	<div class="col-sm-12">
		<div class="breadcrumb">
			...
			<center><h4>
				<i class="fa fa-file-text-o"></i> Tipo de Servicio - Granja Tarapoto
			</h4></center>
		</div>
	</div>
</div> <br><br>
			...
			<div class="sidebar-wrapper">
				<ul class="nav nav-tabs nav-justified" id="sidebar-tab">
					<li class="active" style="font-size:18px;padding:5px;">
						<a href="#users" role="tab" data-toggle="tab"><i class="fa fa-list"></i> Registro Tipo Servicio</a>
					</li>
				</ul>
							...
							<div class="panel-body">
								<form class="form-horizontal" id="form"> <br>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<?php echo form_input('tps_descripcion',"",'id="tps_descripcion" class="form-control" required'); ?>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<?php echo form_input('tps_abreviatura',"",'id="tps_abreviatura" class="form-control" required'); ?>
										</div>
									</div>
